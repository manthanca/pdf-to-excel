...
BROKER_CONFIG = {
    'ANGELONE': {
        ...
        'headers': [
            'ISIN', 'Security Name / Symbol', 'Quantity (Buy)', 'WAP (Across Exchanges) (Buy)', 'Brokerage Per Share (Rs) (Buy)', 'WAP (Across Exchanges) After Brokerage (Rs) (Buy)', 'Total BUY Value After Brokerage', 'Quantity (Sell)', 'WAP (Across Exchanges) (Sell)', 'Brokerage Per Share (Rs) (Sell)', 'WAP (Across Exchanges) After Brokerage (Rs) (Sell)', 'Total SELL Value After Brokerage', 'Net Quantity', 'Net Obligation For ISIN'
        ],
        'mapping_rule': {
